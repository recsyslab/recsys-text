...
## 3. 次元削減
カレーデータベースが**表2.b**のとおりであるとする。各行はアイテム$$i$$に関するデータを表す。$$x_{i,k} \in \{1, 2, \ldots, 10\}$$はアイテム$$i$$の属性$$k$$の特徴量を表し、アイテム$$i$$の特徴ベクトルは$$\boldsymbol{x}_{i} = [x_{i,1}, x_{i,2}, x_{i,3}]^{\mathsf{T}}$$と表す。このとき、次の問いに答えなさい。
...
### 演習問題11
**表2.b**のカレーの特徴ベクトルで張られる3次元特徴空間を主成分分析により2次元特徴空間に縮約したとき、アイテム1の第1および第2主成分得点を求めなさい。ただし、分散共分散行列
