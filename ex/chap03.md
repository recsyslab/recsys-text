...
### 演習問題15
Brunoの訓練データ$$D_{2}^{L}$$を、「チョコなし」（$$x_{i,4} = 0$$）の事例集合$$D_{2}^{L0}$$と、「チョコあり」（$$x_{i,4} = 1$$）の事例集合$$D_{2}^{L1}$$に分割したとする。このとき、それぞれのジニ係数$$G(D_{2}^{L1})$$、$$G(D_{2}^{L0})$$を求めなさい。

### 演習問題16
Brunoの訓練データ$$D_{2}^{L}$$を、それぞれ次の基準で分割したとき、その分割のよさをジニ係数の加重平均により求めなさい。

#### (1) 「チョコなし」（$$x_{i,4} = 1$$）の事例集合$$D_{2}^{L0}$$と、「チョコあり」（$$x_{i,4} = 1$$）の事例集合$$D_{2}^{L1}$$

#### (2) 「ラズベリーなし」（$$x_{i,2} = 1$$）の事例集合$$D_{2}^{L0}$$と、「ラズベリーあり」（$$x_{i,2} = 1$$）の事例集合$$D_{2}^{L1}$$

#### (3) 「ホイップなし」（$$x_{i,5} = 1$$）の事例集合$$D_{2}^{L0}$$と、「ホイップあり」（$$x_{i,5} = 1$$）の事例集合$$D_{2}^{L1}$$
